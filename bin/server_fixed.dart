...
Future<void> handleRequest(HttpRequest request, Database db) async {
  // Add CORS headers
...
Future<void> handleRegister(HttpRequest request, Database db) async {
...
// Handle user login
Future<void> handleLogin(HttpRequest request, Database db) async {
  final body = await utf8.decoder.bind(request).join();
  final data = jsonDecode(body) as Map<String, dynamic>;
...
Future<void> handleGetAllPoems(HttpRequest request, Database db) async {
  try {
...
Future<void> handleGetPoemById(HttpRequest request, Database db, int id) async {
  try {
...
// Handle create poem
Future<void> handleCreatePoem(HttpRequest request, Database db) async {
